...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.setSelectedTabIndicatorColor(R.color.tw__composer_black);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    tab1complain tab1complain=new tab1complain();
                    return tab1complain;
                case 1:
                    tab2notification tab2notification=new tab2notification();
                    return tab2notification;
                case 2:
                    tab3chart tab3chart=new tab3chart();
                    return tab3chart;
                default:
                    return null;
            }
